                ...
                <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="medidas_dados" role="form" action="">
                    ...
                    <div class="tab-content" id="tabdados_medidas">
                        <div class="tab-pane fade show active" id="dados_medidas" role="tabpanel" aria-labelledby="dados_medidas">
                            <div class="col-md-6">
                                    <label for="peso_medidas" class="form-label">peso</label>
                                <input type="text" class="form-control" id="peso_medidas" name="peso_medidas" maxlength="50" value="<?php echo isset($resultado['peso']) ?  str_replace(".", ",", $resultado["peso"]) : ''; ?> " autofocus>
                            </div>
                            <div class="col-md-6">
                                <label for="altura_medidas" class="form-label">altura</label>
                                <input type="text" class="form-control" id="altura_medidas" name="altura_medidas" maxlength="50" value="<?php echo isset($resultado['altura']) ?  str_replace(".", ",", $resultado["altura"]) : ''; ?>" autofocus>
                            </div>
                            <div class="col-md-6">
                                <label for="datac_medidas" class="form-label">data</label>
                                <input type="date" class="form-control" id="data_medidas" name="data_medidas" maxlength="50" value="<?php echo isset($resultado['data']) ? str_replace(".", ",", $resultado["data"]) : ''; ?>" autofocus>
                            </div>
